...
- [ ] Capture V100, A100, and H100 software/hardware environments.
...
- [ ] CUDA WMMA on SM70, then inline PTX `mma.sync` on SM80.
- [ ] Express the SM70/SM80 kernel family with CuTE layouts and tiled MMA.
